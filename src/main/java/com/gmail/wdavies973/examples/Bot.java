//package com.gmail.wdavies973.examples;
//
//import com.gmail.wdavies973.speechGeneration.SilenceAudioSendHandler;
//import com.gmail.wdavies973.lib.VocalCord;
//import com.gmail.wdavies973.lib.VocalCordEngine;
...
//        VocalCordEngine vocalCordEngine = new VocalCordEngine("okay bought", new VocalCord() {
//            // This method is called when a voice command is processed, here it just sends the text back to the text channel
//            @Override
//            public void onTranscribed(String command) {
...
//        vocalCordEngine.setCombinedAudio(true);
//        // Set the speech handler
//        manager.setReceivingHandler(vocalCordEngine);
//
